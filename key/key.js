...
const ip_address = "http://192.168.171.128:";
module.exports = {
    tessera: {
      member1: {
    ...
    besu: {
      member1: {
        name: "member1",
        url: ip_address + "20000",
        wsUrl: ip_address + "20001",
        privateUrl: ip_address + "9081",
        nodekey:
      ...
      member2: {
        name: "member2",
        url: ip_address + "20002",
        wsUrl: ip_address + "20003",
        privateUrl: ip_address + "9082",
        nodekey:
      ...
      member3: {
        name: "member3",
        url: ip_address + "20004",
        wsUrl: ip_address + "20005",
        privateUrl: ip_address + "9083",
        nodekey:
